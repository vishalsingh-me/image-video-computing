...
find_library( 585_VBOW_SHARED_LIB 585-ivc-vbow
    PATHS ${PKG_ROOT}/lib
)
...
find_package_handle_standard_args( ImClsLibs
    REQUIRED_VARS 585_INCLUDE_DIR 585_COMMON_SHARED_LIB 585_IO_SHARED_LIB
                  ...
                  585_GRAD_SHARED_LIB 585_VBOW_SHARED_LIB )

if( ImClsLibs_FOUND )
    set( ImClsLibs_INCLUDE_DIR ${585_INCLUDE_DIR} )
    set( ImClsLibs_LIBRARIES ${585_COMMON_SHARED_LIB} ${585_IO_SHARED_LIB}
                             ${585_FILTERING_SHARED_LIB} ${585_IMGPROC_SHARED_LIB} ${585_HOUGH_SHARED_LIB}
                             ${585_GRAD_SHARED_LIB} ${585_VBOW_SHARED_LIB} )
    ...
    if( OpenCV_FOUND AND 585_OPENCV_SHARED_LIB )
        # append it to ImgClsLibs_LIBRARIES
        list( APPEND ImClsLibs_LIBRARIES ${585_OPENCV_SHARED_LIB} )
    endif()
endif()
